    ...
    <div class="row justify-content-center">
        <div class="col-sm-8">
            ...
            <div class="text-center">
                <a href="<?= site_url('/') ?>" class="btn btn-light px-5"><i class="fa-solid fa-ban me-2"></i>Cancelar</a>
                <a href="<?= site_url('delete_task_confirm/' . encrypt($task->id)) ?>" class="btn btn-light px-5"><i class="fa-solid fa-trash-can me-2"></i>Eliminar</a>
             </div>
